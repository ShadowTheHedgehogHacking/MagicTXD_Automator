...
{
    AINLINE nativeImageTypeInterface( EngineInterface *engineInterface, nativeImageTypeManager *typeMan, size_t objSize )
    {
        this->engineInterface = engineInterface;
                ...
                try
                {
                    ...
                    RwTypeSystem::typeInfoBase *nativeImgType =
                        engineInterface->typeSystem.RegisterCommonTypeInterface <nativeImageTypeInterface> (
                            typeName, imgBaseType, engineInterface, typeManager, memSize
                        );
