    ...
    void WriteToNativeTexture( Interface *engineInterface, void *imageMem, const char *nativeTexName, void *nativeTexMem, acquireFeedback_t& feedbackOut ) const override
    {
...
#endif //RWLIB_INCLUDE_NATIVETEX_D3D9
        {
            ...
            try
            {
                ...
                {
                    throw RwException( rwStaticString <char> ( "failed to push DDS native image color data to " ) + nativeTexName + " native texture due to unsupported DDS format" );
                }
    ...
    void ReadNativeImage( Interface *engineInterface, void *imageMem, Stream *inputStream ) const override
    {
        ...
        eDDSPixelFormatType formatType;
        {
                 ...
                 ( hasPal8 && formatType != eDDSPixelFormatType::FMT_PAL8 ) )
            {
                ...
                rwStaticString <char> warningMsg = "ambiguous DDS native image format: ";

                if ( hasRGB )
                {
                    warningMsg +=
                        getDDSPixelFormatTypeName( eDDSPixelFormatType::FMT_RGB );
                    warningMsg += " ";
                }
                ...
                {
                    warningMsg +=
                        getDDSPixelFormatTypeName( eDDSPixelFormatType::FMT_YUV );
                    warningMsg += " ";
                }
                ...
                {
                    warningMsg +=
                        getDDSPixelFormatTypeName( eDDSPixelFormatType::FMT_LUM );
                    warningMsg += " ";
                }
                ...
                {
                    warningMsg +=
                        getDDSPixelFormatTypeName( eDDSPixelFormatType::FMT_ALPHA );
                    warningMsg += " ";
                }
                ...
                {
                    warningMsg +=
                        getDDSPixelFormatTypeName( eDDSPixelFormatType::FMT_PAL4 );
                    warningMsg += " ";
                }
                ...
                {
                    warningMsg +=
                        getDDSPixelFormatTypeName( eDDSPixelFormatType::FMT_PAL8 );
                    warningMsg += " ";
                }

                warningMsg += "formats specified; ";
                warningMsg += getDDSPixelFormatTypeName( formatType );
                warningMsg += " format selected";
