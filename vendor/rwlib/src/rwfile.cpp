...
struct ANSIFileInterface : public FileInterface
{
    ...
    filePtr_t   OpenStreamW( const wchar_t *streamPath, const wchar_t *streamMode ) override
    {
        ...
        auto utf8_streamPath = CharacterUtil::ConvertStrings <wchar_t, char8_t, RwStaticMemAllocator> ( streamPath );
        auto utf8_streamMode = CharacterUtil::ConvertStrings <wchar_t, char8_t, RwStaticMemAllocator> ( streamMode );
