...
public:
    ...
    )
    {
        ...
        {
            void *headerMem = engineInterface->MemAllocate( sizeof( pvrtexture::CPVRTextureHeader ) + FUTURE_BUFFER_EXAPAND, alignof(pvrtexture::CPVRTextureHeader) );
    ...
    PVRTexture PVRTextureCreate( Interface *engineInterface, PVRTextureHeader header, const void *dataPtr = nullptr )
    {
        ...
        {
            void *texMem = engineInterface->MemAllocate( sizeof( pvrtexture::CPVRTexture ) + FUTURE_BUFFER_EXAPAND, alignof(pvrtexture::CPVRTexture) );
    ...
    PVRPixelType PVRPixelTypeCreateByFormat( Interface *engineInterface, pvrtexture::uint64 format )
    {
        ...
        {
            void *pixelTypeMem = engineInterface->MemAllocate( sizeof( pvrtexture::PixelType ) + FUTURE_BUFFER_EXAPAND, alignof(pvrtexture::PixelType) );
