...
#define NATIVE_DRIVER_OBJ_TYPEINTERFACE( canonicalName ) \
    ...
    struct nativeDriverGraphicsStateTypeInterface : public RwTypeSystem::typeInterface
    {
        ...
        size_t GetTypeSize( EngineInterface *engineInterface, void *construct_params ) const override
        {
            return this->objMemSize + sizeof( DriverGraphicsState );
        }
    ...
    struct nativeDriverCmdBufferTypeInterface : public RwTypeSystem::typeInterface
    {
        ...
        void CopyConstruct( void *mem, const void *srcMem ) const override
        {
            throw RwException( "cannot clone command buffers" );
        }
        ...
        size_t GetTypeSize( EngineInterface *engineInterface, void *constr_params ) const override
        {
            return this->objMemSize + sizeof(DriverCmdBuffer);
        }
    ...
    struct nativeDriverCmdAllocatorTypeInterface : public RwTypeSystem::typeInterface
    {
        void Construct( void *mem, EngineInterface *engineInterface, void *constr_params ) const override
        {
        ...
        void CopyConstruct( void *mem, const void *srcMem ) const override
        {
            throw RwException( "cannot clone command allocators" );
        }
        ...
        size_t GetTypeSize( EngineInterface *engineInterface, void *cparams ) const override
        {
            return this->objMemSize + sizeof(DriverCmdAlloc);
        }
    ...
    struct nativeDriverCmdQueueTypeInterface : public RwTypeSystem::typeInterface
    {
        void Construct( void *mem, EngineInterface *engineInterface, void *constr_params ) const override
        {
        ...
        void CopyConstruct( void *mem, const void *srcMem ) const override
        {
            throw RwException( "cannot clone driver command queues" );
        }
        ...
        size_t GetTypeSize( EngineInterface *engineInterface, void *constr_params ) const override
        {
            return this->objMemSize + sizeof(DriverCmdQueue);
        }

        size_t GetTypeSizeByObject( EngineInterface *engineInterface, const void *srcObj ) const override
        {
            return this->objMemSize + sizeof(DriverCmdQueue);
        }
    ...
    struct nativeDriverFenceTypeInterface : public RwTypeSystem::typeInterface
    {
        void Construct( void *mem, EngineInterface *engineInterface, void *constr_params ) const override
        {
        ...
        void CopyConstruct( void *mem, const void *srcMem ) const override
        {
            throw RwException( "cannot clone driver fences" );
        }
        ...
        size_t GetTypeSize( EngineInterface *engineInterface, void *constr_params ) const override
        {
            return this->objMemSize + sizeof(DriverFence);
        }
    ...
    struct nativeDriverGPUMemTypeInterface : public RwTypeSystem::typeInterface
    {
        void Construct( void *mem, EngineInterface *engineInterface, void *constr_params ) const override
        {
        ...
        void CopyConstruct( void *mem, const void *srcMem ) const override
        {
            throw RwException( "cannot clone driver memory" );
        }
        ...
        size_t GetTypeSize( EngineInterface *engineInterface, void *constr_params ) const override
        {
            return this->objMemSize + sizeof(DriverMemory);
        }
...
struct driverEnvironment
{
    ...
    inline void operator = ( const driverEnvironment& right )
    {
        throw RwException( "cannot clone RenderWare GPU driver environment" );
    }
