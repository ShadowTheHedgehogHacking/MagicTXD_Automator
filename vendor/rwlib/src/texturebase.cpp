// TextureBase type main source file.
...
static PluginDependantStructRegister <textureConsistencyEnv, RwInterfaceFactory_t> textureConsistencyRegister;
...
static inline rwlock* GetTextureLock( const TextureBase *texHandle )
{
    ...
    textureConsistencyEnv *lockEnv = textureConsistencyRegister.GetPluginStruct( engineInterface );
...
void registerTextureBasePlugins( void )
{
    ...
    textureConsistencyRegister.RegisterPlugin( engineFactory );
