...
inline void getDefaultRasterFormatString( eRasterFormat rasterFormat, uint32 itemDepth, ePaletteType paletteType, eColorOrdering colorOrder, eir::String <char, allocatorType>& formatOut )
{
