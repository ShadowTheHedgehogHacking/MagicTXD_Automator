...
struct tiffImagingExtension : public imagingFormatExtension
{
    ...
    inline static rwStaticString <char> create_tiff_error_string( const char *whatType, const char *module, const char *fmt, va_list argPtr )
    {
        rwStaticString <char> full_msg( "libtiff " + rwStaticString <char> ( whatType ) );

        if ( module )
        {
            full_msg += " (module: " + rwStaticString <char> ( module ) + "): ";
        }
        else
        {
            full_msg += ": ";
    ...
    static void TIFFWarningHandlerExt( thandle_t ioptr, const char *module, const char *fmt, va_list argPtr )
    {
        ...
        rwStaticString <char> message = create_tiff_error_string( "warning", module, fmt, argPtr );
    ...
    static void TIFFErrorHandlerExt( thandle_t ioptr, const char *module, const char *fmt, va_list argPtr )
    {
        ...
        rwStaticString <char> message = create_tiff_error_string( "error", module, fmt, argPtr );
