...
)
{
    ...
    {
        // Decompress, wazaaa!
        CMP_ERROR atcErrorCode = CMP_ConvertTexture( &srcTexture, &dstTexture, nullptr, nullptr, 0, 0 );
        ...
        try
        {
            // Compress the texture now.
            {
                ...
                CMP_ERROR atcErrorCode =
                    CMP_ConvertTexture( &srcTexture, &dstTexture, nullptr, nullptr, 0, 0 );
