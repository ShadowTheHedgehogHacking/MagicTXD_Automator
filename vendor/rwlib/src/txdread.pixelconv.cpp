...
{
    return colorModelDispatcher ( rasterFormat, colorOrder, depth, nullptr, 0, PALETTE_NONE ).setRGBA( texelSource, texelIndex, red, green, blue, alpha );
}
...
{
    return colorModelDispatcher ( rasterFormat, COLOR_RGBA, depth, nullptr, 0, PALETTE_NONE ).setLuminance( texelSource, texelIndex, lum, alpha );
}
