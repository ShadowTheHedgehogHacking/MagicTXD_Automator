...
struct rwImagingEnv
{
    ...
    struct formatListMapComparator
    {
        AINLINE static bool is_less_than( const rwStaticString <char>& left, const rwStaticString <char>& right )
        {
            return (
                FixedStringCompare(
    ...
    typedef rwMap <rwStaticString <char>, registeredExtension, formatListMapComparator> formatList_t;
