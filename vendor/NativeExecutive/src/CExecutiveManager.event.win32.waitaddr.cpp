...
static decltype( &WaitOnAddress ) func_WaitOnAddress = nullptr;
static decltype( &WakeByAddressAll ) func_WakeByAddressAll = nullptr;
...
void _event_win32_waitaddr_constructor( void *mem )
{
...
void _event_win32_waitaddr_destructor( void *mem )
{
    // Nothing.
}
...
void _event_win32_waitaddr_wait( void *mem )
{
    _event_win32_waitaddr *obj = (_event_win32_waitaddr*)mem;
...
bool _event_win32_waitaddr_wait_timed( void *mem, unsigned int msTimeout )
{
    _event_win32_waitaddr *obj = (_event_win32_waitaddr*)mem;
