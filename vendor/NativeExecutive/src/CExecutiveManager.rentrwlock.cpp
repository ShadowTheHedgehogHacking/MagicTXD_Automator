...
static optional_struct_space <PluginDependantStructRegister <PerThreadPluginRegister <_rwlock_rent_thread_ctx_env, true, true>, executiveManagerFactory_t>> _rwlock_rent_thread_ctx_reg;
