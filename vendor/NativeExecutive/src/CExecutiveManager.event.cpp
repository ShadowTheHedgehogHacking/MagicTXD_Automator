...
extern void _event_win32_evthandle_constructor( void *mem );
extern void _event_win32_evthandle_destructor( void *mem );
extern void _event_win32_evthandle_set( void *mem, bool shouldWait );
extern void _event_win32_evthandle_wait( void *mem );
extern bool _event_win32_evthandle_wait_timed( void *mem, unsigned int msTimeout );
...
extern void _event_win32_waitaddr_constructor( void *mem );
extern void _event_win32_waitaddr_destructor( void *mem );
extern void _event_win32_waitaddr_set( void *mem, bool shouldWait );
extern void _event_win32_waitaddr_wait( void *mem );
extern bool _event_win32_waitaddr_wait_timed( void *mem, unsigned int msTimeout );
...
extern void _event_linux_futex_constructor( void *mem );
extern void _event_linux_futex_destructor( void *mem );
extern void _event_linux_futex_set( void *mem, bool shouldWait );
extern void _event_linux_futex_wait( void *mem );
extern bool _event_linux_futex_wait_timed( void *mem, unsigned int msTimeout );
...
static size_t _evtMemSize = 0;
static size_t _evtAlignment = 0;
static void (*_event_constructor)( void *mem ) = nullptr;
static void (*_event_destructor)( void *mem ) = nullptr;
static void (*_event_set)( void *mem, bool shouldWait ) = nullptr;
static void (*_event_wait)( void *mem ) = nullptr;
static bool (*_event_wait_timed)( void *mem, unsigned int msTimeout ) = nullptr;
...
void pubevent_constructor( void *mem )
{
    _event_constructor( mem );
}
...
// Library-dynamic API.
CEvent* CExecutiveManager::CreateEvent( void )
{
    if ( _evtMemSize == 0 )
    {
        return nullptr;
...
// Event methods.
void CEvent::Set( bool shouldWait )
{
...
bool CEvent::WaitTimed( unsigned int msTimeout )
{
...
static std::atomic <size_t> _eventman_refcnt = 0;
