...
void* FileSysCommonAllocator::Allocate( void *refPtr, size_t memSize, size_t alignment )
{
...
bool FileSysCommonAllocator::Resize( void *refPtr, void *memPtr, size_t memSize )
{
#ifdef FILESYS_MULTI_THREADING
...
void FileSysCommonAllocator::Free( void *refPtr, void *memPtr )
{
#ifdef FILESYS_MULTI_THREADING
...
void* CFileSystem::MemAlloc( size_t memSize, size_t alignment )
{
...
bool CFileSystem::MemResize( void *memPtr, size_t memSize )
{
    CFileSystemNative *nativeMan = (CFileSystemNative*)this;
...
void CFileSystem::MemFree( void *memPtr )
{
    CFileSystemNative *nativeMan = (CFileSystemNative*)this;
