...
struct xboxIMGCompression : public CIMGArchiveCompressionHandler
{
    ...
    struct simpleWorkBuffer
    {
        ...
        inline simpleWorkBuffer( simpleWorkBuffer&& right )
        {
        ...
        inline simpleWorkBuffer& operator = ( simpleWorkBuffer&& right )
        {
        ...
        inline void Grow( size_t growBy )
        {
            ...
            this->buffer = TemplateMemTransalloc( memAlloc, nullptr, this->buffer, this->bufferSize, newSize, 1 );
