...
public:
    ...
    void*                   MemAlloc                ( size_t memSize, size_t alignment );
    bool                    MemResize               ( void *memPtr, size_t memSize );
    ...
    CFile*                  WrapStreamBuffered      ( CFile *stream, bool deleteOnQuit ) override;
...
{
    static AINLINE void* Allocate( void *refMem, size_t memSize, size_t alignment )
    {
    ...
    static AINLINE bool Resize( void *refMem, void *memPtr, size_t memSize )
    {
        assert( fileSystem != nullptr );
    ...
    static AINLINE void Free( void *refMem, void *memPtr )
    {
        assert( fileSystem != nullptr );
