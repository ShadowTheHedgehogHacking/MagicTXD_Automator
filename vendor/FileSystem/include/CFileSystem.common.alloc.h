...
{
    static void* Allocate( void *refPtr, size_t memSize, size_t alignment );
    static bool Resize( void *refPtr, void *memPtr, size_t reqSize );
    static void Free( void *refPtr, void *memPtr );
};
