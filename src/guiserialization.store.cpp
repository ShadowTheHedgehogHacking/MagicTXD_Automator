...
static PluginDependantStructRegister <serializationStoreEnv, mainWindowFactory_t> serializationStoreRegister;

magicSerializationProvider* FindMainWindowSerializer( MainWindow *mainWnd, unsigned short unique_id )
{
    serializationStoreEnv *env = serializationStoreRegister.GetPluginStruct( mainWnd );
...
{
    const serializationStoreEnv *env = serializationStoreRegister.GetConstPluginStruct( mainWnd );
...
{
    serializationStoreRegister.RegisterPlugin( mainWindowFactory );
}